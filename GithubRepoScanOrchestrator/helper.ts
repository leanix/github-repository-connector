...
export function checkRegexExcludeList(regexExcludeList) {
  if (regexExcludeList) {
    try {
...
export const iHubStatus = {
  IN_PROGRESS: "IN_PROGRESS",
  FINISHED: "FINISHED",
  FAILED: "FAILED"
};

export const iHubProgressOrigin = {
  CONNECTOR: "CONNECTOR"
};

export function getISODateStringOnFromToday(daysBack = 30) {
